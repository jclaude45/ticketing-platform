...
export const metadata: Metadata = { title: 'Setup Two-Factor Authentication' };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-950 via-purple-900 to-slate-900 p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Enable 2FA</h1>
          <p className="text-indigo-200 mt-2">Add an extra layer of security to your account</p>
        </div>
