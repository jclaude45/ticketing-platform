...
export function ConfirmDialog({
  ...
  /* Always in DOM — visibility+opacity+pointer-events transition avoids AnimatePresence removeChild bug */
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div
        className={cn(
          'relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 w-full max-w-md border border-gray-200 dark:border-gray-700 transition-all duration-200',
          open ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-90 translate-y-5',
        )}
      >
        <button
          onClick={onClose}
